...
const Profile = () => {
  ...
  return (
    <div className="flex h-screen">
      <Navbar />
      <div className="ml-20 mr-4 flex-1 p-6 flex flex-col items-center min-h-screen w-full">
        ...
        {formVisible ? (
          ...
          <>
            <div className="p- flex flex-col items-center w-full max-w-md">
              {trainer?.imgUrl ? (
                <img
                  src={trainer.imgUrl}
                  alt="Avatar"
            ...
            <div className="w-full mt-8">
              <h2 className="text-xl font-bold text-center mb-6">Pokémons rencontrés</h2>
              {pkmnSeen.length > 0 ? (
              ...
              <h2 className="text-xl font-bold text-center mt-10 mb-6">Pokémons capturés</h2>
              {pkmnCatch.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
