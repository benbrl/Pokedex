...
const Profile = () => {
  ...
  return (
    <div className="flex h-screen">
      <Navbar />
      <div className="ms-8 flex flex-col items-center p-6 min-h-screen w-full">
        <Link to="/settings" className="absolute top-4 right-4 p-1.5 text-gray-700 focus:outline-none transition-colors duration-200 rounded-lg dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-100">
        ...
        {formVisible ? (
          ...
          <>
            ...
            <div className="w-full ml-20 mr-13 mt-10">
